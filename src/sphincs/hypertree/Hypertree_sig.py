...
class hypertree_sig(Generic[T]):
    ...
    @staticmethod
    def from_bytes(sig_bytes: bytes, h: int, n: int, d: int, len_wots: int) -> "hypertree_sig[xmss_sig]":
        xmss_sigs = []
        offset = 0
        ...
        for _ in range(d):
            ...
            offset += xmss_sig_len
            xmss_sigs.append(xmss_sig.from_bytes(chunk, h // d, n, len_wots))

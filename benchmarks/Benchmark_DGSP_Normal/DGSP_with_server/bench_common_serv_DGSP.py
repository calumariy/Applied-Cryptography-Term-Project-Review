...
SERVER_PORT = 65432
SERVER_PY   = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bench_server.py")
...
"""
def start_server(params: SphincsParams,
...
@contextmanager
def managed_server(params: SphincsParams,
                   host: str = SERVER_HOST,
...
def run_verify_server(label: str, params: SphincsParams,
                    n_runs: int = N_RUNS, n_warmup: int = N_WARMUP,
                    host=SERVER_HOST, port=SERVER_PORT) -> dict:
    counter = 0;

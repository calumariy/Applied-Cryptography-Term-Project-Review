...
from bench_common_serv_DGSP_C import managed_server, run_verify_server, N_RUNS, N_WARMUP

PARAM_SETS = [
    # label,                          n,  w,  h, d, k,  t, t_prime, z
    ("small-dev  (h=6,  d=2, k=4)",  16, 16,  6, 2,  4,   4, 4, 0),
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Verify C (server) Benchmark")
    print("=" * 56)

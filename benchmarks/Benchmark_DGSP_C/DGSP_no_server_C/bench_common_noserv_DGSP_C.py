...
def build_signature(params: SphincsParamsC, manager, user_id, cstar, msg):
    """
...
def run_keygen_DGSP(label: str, params: SphincsParamsC,
...
def run_resp_m_DGSP(label: str, params: SphincsParamsC,
                    n_runs: int = N_RUNS, n_warmup: int = N_WARMUP) -> dict:
    m = Manager(params)
    pk = m.keygen()
...
def run_open_DGSP(label: str, params: SphincsParamsC,
                  n_runs: int = N_RUNS, n_warmup: int = N_WARMUP) -> dict:
    m = Manager(params)
    pk = m.keygen()
    user_id, cstar_id = m.join("alice")
...
def run_revoke_DGSP(label: str, params: SphincsParamsC,
                    n_runs: int = N_RUNS, n_warmup: int = N_WARMUP) -> dict:
    m = Manager(params)
    pk = m.keygen()
...
def run_judge_DGSP(label: str, params: SphincsParamsC,
                   n_runs: int = N_RUNS, n_warmup: int = N_WARMUP) -> dict:
    m = Manager(params)
    pk = m.keygen()
    user_id, cstar_id = m.join("alice")
...
def run_sig_size_DGSP(label: str, params: SphincsParamsC,
                      n_runs: int = N_RUNS, n_warmup: int = N_WARMUP) -> dict:
    """

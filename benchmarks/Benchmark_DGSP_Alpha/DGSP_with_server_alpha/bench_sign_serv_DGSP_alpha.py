"""
SPHINCS+ DGSP Sign Benchmark (server-ed)
===================================
Measures wall-clock time for Member.Sign across parameter sets.
Methodology:
...
from bench_common_serv_DGSP_alpha import run_sign_server, managed_server, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_sign_server(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Sign Alpha (server) Benchmark")
    print("=" * 56)

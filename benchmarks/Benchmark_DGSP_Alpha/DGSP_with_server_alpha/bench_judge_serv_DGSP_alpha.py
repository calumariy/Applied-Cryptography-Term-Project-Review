"""
SPHINCS+ DGSP Judge Benchmark (server-ed)
===================================
Measures wall-clock time for judge across parameter sets.
Methodology:
...
from bench_common_serv_DGSP_alpha import managed_server, run_judge_server, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_judge_server(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Judge Alpha (server) Benchmark")
    print("=" * 56)

...
from bench_common_serv_DGSP_alpha import managed_server, run_resp_m_server, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_resp_m_server(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Resp_M Alpha (server) Benchmark")
    print("=" * 56)

"""
SPHINCS+ DGSP Resp_M Benchmark (serverless)
===================================
Measures wall-clock time for dgsp_resp_m across parameter sets.
Methodology:
...
from bench_common_noserv_DGSP_alpha import run_resp_m_DGSP, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_resp_m_DGSP(label, params, n_runs, n_warmup)
...
def print_results(r: dict):
    ...
    print(f"  Cert Size  : {r['cert_size']} bytes  ({r['cert_size'] * 8} bits)")

if __name__ == "__main__":
    print("SPHINCS+ DGSP Resp_M Alpha (Serverless) Benchmark")
    print("=" * 56)

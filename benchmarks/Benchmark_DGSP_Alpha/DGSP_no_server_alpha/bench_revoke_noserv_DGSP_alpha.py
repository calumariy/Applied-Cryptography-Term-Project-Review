"""
SPHINCS+ DGSP Revoke Benchmark (serverless)
===================================
Measures wall-clock time for dgsp_revoke across parameter sets.
Methodology:
...
from bench_common_noserv_DGSP_alpha import run_revoke_DGSP, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_revoke_DGSP(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Revoke Alpha (Serverless) Benchmark")
    print("=" * 56)

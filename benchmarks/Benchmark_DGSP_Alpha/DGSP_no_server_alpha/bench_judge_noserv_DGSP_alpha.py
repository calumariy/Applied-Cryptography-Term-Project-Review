"""
SPHINCS+ DGSP Judge Benchmark (serverless)
===================================
...
from bench_common_noserv_DGSP_alpha import run_judge_DGSP, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_judge_DGSP(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ DGSP Judge Alpha (Serverless) Benchmark")
    print("=" * 56)

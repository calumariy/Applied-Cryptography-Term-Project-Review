"""
SPHINCS+ Signing Benchmark
===================================
Measures wall-clock time for spx_sign across parameter sets.
...
from bench_common import run_sign_sphincs_plus_c, N_RUNS, N_WARMUP

PARAM_SETS = [
    # label,                          n,  w,  h, d, k,  t, t_prime, z
    ("small-dev  (h=6,  d=2, k=4)",  16, 16,  6, 2,  4,   8, 8, 8),
    ("medium-dev (h=12, d=3, k=6)",  16, 16, 12, 3,  6,  16, 16, 16),
]
...
if __name__ == "__main__":
    print("SPHINCS+C Verification Benchmark")
    print("=" * 56)
    for label, n, w, h, d, k, t in PARAM_SETS:
        params = SphincsParamsC(n=n, w=w, h=h, d=d, k=k, t=t)
        print_results(run_sign_sphincs_plus_c(label, params))
    print(f"\n{'=' * 56}\nDone.")
...
from bench_common import run_keygen_sphincs_plus_c, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsC,
    ...
    return run_keygen_sphincs_plus_c(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+C Key Generation Benchmark")
    print("=" * 56)

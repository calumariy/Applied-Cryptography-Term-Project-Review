"""
SPHINCS+C Signing Benchmark
===================================
Measures wall-clock time for sphincs_c.sign across parameter sets.
...
from bench_common_C import run_sign_sphincs_plus_c, N_RUNS, N_WARMUP

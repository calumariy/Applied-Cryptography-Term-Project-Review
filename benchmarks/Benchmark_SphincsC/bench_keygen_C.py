"""
SPHINCS+C Key Generation Benchmark
===================================
Measures wall-clock time for sphincs_c.keygen across parameter sets.
Methodology:
...
from bench_common_C import run_keygen_sphincs_plus_c, N_RUNS, N_WARMUP

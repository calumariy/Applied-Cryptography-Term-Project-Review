"""
SPHINCS+C Verification Benchmark
===================================
Measures wall-clock time for sphincs_C_verify across parameter sets.
...
from bench_common_C import run_verify_sphincs_plus_c, N_RUNS, N_WARMUP

"""
SPHINCS+ Alpha Key Generation Benchmark
===================================
Measures wall-clock time for sphincs_alpha.keygen() across parameter sets.
Methodology:
...
from bench_common_alpha import run_keygen_sphincs_alpha, N_RUNS, N_WARMUP
...
def run(label: str, params: SphincsParamsAlpha,
    ...
    return run_keygen_sphincs_alpha(label, params, n_runs, n_warmup)
...
if __name__ == "__main__":
    print("SPHINCS+ Alpha Key Generation Benchmark")
    print("=" * 56)

"""
SPHINCS+ Alpha Verification Benchmark
===================================
Measures wall-clock time for sphincs_alpha.verify() across parameter sets.
...
from bench_common_alpha import run_verify_sphincs_alpha, N_RUNS, N_WARMUP

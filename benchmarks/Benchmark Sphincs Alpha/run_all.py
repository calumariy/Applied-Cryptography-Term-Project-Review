...
RUNNERS = {
    "keygen": bench_common.run_keygen_sphincs_alpha,
    "sign":   bench_common.run_sign_sphincs_alpha,
    "verify": bench_common.run_verify_sphincs_alpha,
    "sig_size": bench_common.run_sig_size_sphincs_alpha,
}

# CSV columns emitted for every operation
_BASE_FIELDS = ["rank", "n", "w", "h", "d", "k", "t",
